...
export interface ElectronPltHookStats extends ElectronPltHookInstallResult {
  ...
  nodeCreateEnvironmentArgTraceFailures?: number;
  lastNodeCreateEnvironmentIsolateData?: number;
  lastNodeCreateEnvironmentContext?: number;
  lastNodeCreateEnvironmentResult?: number;
  lastNodeCreateEnvironmentInitScript?: string;
  lastNodeCreateEnvironmentArgs?: string;
  lastNodeCreateEnvironmentExecArgs?: string;
  ...
  nodePreLoadProbeAttempts?: number;
  nodePreLoadProbeSuccesses?: number;
  nodePreLoadProbeFailures?: number;
  nodePreLoadProbeResultReads?: number;
  nodePreLoadProbeResultReadFailures?: number;
  nodePreLoadProbeHiddenWrites?: number;
  lastNodePreLoadProbeResult?: string;
  lastNodePreLoadProbeHiddenValue?: string;
  preLoadEnvResult?: string;
  nodePostLoadTraceAttempts?: number;
  nodePostLoadTraceSuccesses?: number;
  nodePostLoadTraceFailures?: number;
  nodePostLoadTraceResultReads?: number;
  nodePostLoadTraceResultReadFailures?: number;
  lastNodePostLoadTraceResult?: string;
  lastNodePostLoadStage?: string;
  postLoadEnvResult?: string;
  entryProbeEnvResult?: string;
  browserInitEnvO?: string;
  browserInitDefineOCalls?: number;
  browserInitDefineO?: string;
  browserInitStageDefineCalls?: number;
  browserInitStageDefines?: string;
  ...
  v8CompileFunctionSlots?: number;
  v8CompileFunctionInlineInstalled?: boolean;
  v8CompileFunctionInlineEntrypoints?: number;
  v8CompileFunctionInlineFailures?: number;
  v8CompileFunctionCalls?: number;
  v8CompileFunctionSourceReads?: number;
  v8CompileFunctionSourceReadFailures?: number;
  v8CompileFunctionMarkerHits?: number;
  v8CompileFunctionResetSearchPathHits?: number;
  lastV8CompileFunctionContext?: number;
  lastV8CompileFunctionSourcePtr?: number;
  lastV8CompileFunctionArgCount?: number;
  lastV8CompileFunctionOptions?: number;
  lastV8CompileFunctionNoCacheReason?: number;
  lastV8CompileFunctionSourceSlots?: string;
  lastV8CompileFunctionSource?: string;
  firstV8CompileFunctionSource?: string;
  interestingV8CompileFunctionSource?: string;
  v8CompileFunctionSourceSequence?: string;
  v8ObjectSetPrivateSlots?: number;
  v8ObjectSetPrivateCalls?: number;
  v8ObjectDefineOwnPropertySlots?: number;
  v8ObjectDefineOwnPropertyCalls?: number;
  v8ObjectDefineOwnPropertyNameReadFailures?: number;
  v8DefineResourcesPathPatches?: number;
  v8ObjectDefineOwnPropertyNames?: string;
  lastDefinedResourcesPath?: string;
  ...
  browserAppSearchPathAsarOnlyFallbackPatches?: number;
  browserAppSearchPathNameReadFailures?: number;
  v8ObjectSetPrivateNames?: string;
  ...
  ohcodeWriteSlots?: number;
  ohcodeWritevSlots?: number;
  uvFsOpenSlots?: number;
  uvFsStatSlots?: number;
  uvFsLstatSlots?: number;
  uvFsAccessSlots?: number;
  uvFsScandirSlots?: number;
  uvFsOpenCalls?: number;
  uvFsStatCalls?: number;
  uvFsLstatCalls?: number;
  uvFsAccessCalls?: number;
  uvFsScandirCalls?: number;
  uvFsResfileCalls?: number;
  lastUvFsOp?: string;
  lastUvFsPath?: string;
  ...
  ohcodeWriteTraceCalls?: number;
  ohcodeWriteTraceBytes?: number;
  lastOhcodeWriteTrace?: string;
